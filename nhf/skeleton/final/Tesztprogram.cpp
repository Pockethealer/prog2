...
int main()
{
...
#endif
    /// Globális paraméterek a teszteléshez:
    ...
    /// Teszteljük a Buyer clasz getter/setter-eit
    ...
    /// Teszteljük a Buyer classz viselkedését
    ...
    /// Item class getter/setterek viselkedését teszteljük
    TEST(Item, variables)
    {
    ...
    /// Az auction class lehetséges inputjaira tesztelünk
    TEST(Auction, input)
    {
        // A mesterséges input
    ...
    /// Az Aukcion classz lehetséges outputjaira teszteljünk
    TEST(Auction, output)
    {
        /// A mesterséges input
    ...
    /// A licitálási logikát teszteli, és lehetőséget ad finomhangolásra
    ...
    /// Mivel az összes memóriafoglalást saját tárolókban tárolom, amik autómatikusan felszabadítják
    /// az adatokat ha out-of-scope kerülnek ezért nem kell manuálisan memóriát kezelni a főprogramban
    return 0;
}
